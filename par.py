...
W0607 02:53:47.262000 22463 torch/onnx/_internal/exporter/_registration.py:107] torchvision is not installed. Skipping torchvision::nms
W0607 02:53:47.263000 22463 torch/onnx/_internal/exporter/_registration.py:107] torchvision is not installed. Skipping torchvision::roi_align
W0607 02:53:47.263000 22463 torch/onnx/_internal/exporter/_registration.py:107] torchvision is not installed. Skipping torchvision::roi_pool
[torch.onnx] Obtain model graph for `QEffGptOssForCausalLM([...]` with `torch.export.export(..., strict=False)`...
`use_return_dict` is deprecated! Use `return_dict` instead!
E0607 02:53:48.293000 22463 torch/export/_trace.py:1323] always_classified is unsupported.
E0607 02:53:48.293000 22463 torch/export/_trace.py:1323] always_classified is unsupported.
[torch.onnx] Obtain model graph for `QEffGptOssForCausalLM([...]` with `torch.export.export(..., strict=False)`... ❌
[torch.onnx] Obtain model graph for `QEffGptOssForCausalLM([...]` with `torch.export.export(..., strict=True)`...
E0607 02:53:49.143000 22463 torch/export/_trace.py:1323] always_classified is unsupported.
E0607 02:53:49.143000 22463 torch/export/_trace.py:1323] always_classified is unsupported.
[torch.onnx] Obtain model graph for `QEffGptOssForCausalLM([...]` with `torch.export.export(..., strict=True)`... ❌
...
<class 'torch._dynamo.exc.TorchRuntimeError'>: RuntimeError when making fake tensor call
  Explanation: Dynamo failed to run FX node with fake tensors: call_function <built-in function gt>(*(FakeTensor(..., size=(1, 1, s59), dtype=torch.int64), FakeTensor(..., device='meta', size=(s74, 1, 1), dtype=torch.int64)), **{}): got RuntimeError('Tensor on device meta is not on the expected device cpu!')
...
from user code:
  ...
  File "/home/amarshar/weightfree-tf5/.venv/lib/python3.12/site-packages/torch/_export/non_strict_utils.py", line 1154, in __torch_function__
    return func(*args, **kwargs)
           ^^^^^^^^^^^^^^^^^^^^^
  File "/home/amarshar/weightfree-tf5/QEfficient/transformers/models/gpt_oss/modeling_gpt_oss.py", line 981, in forward
    hidden_states, self_attn_weights, present_key_value = self.self_attn(
                                                          ^^^^^^^^^^^^^^^
  File "/home/amarshar/weightfree-tf5/QEfficient/transformers/models/gpt_oss/modeling_gpt_oss.py", line 930, in forward
    key_states, value_states, attention_mask, _ = past_key_value_update(
                                                  ^^^^^^^^^^^^^^^^^^^^^^
  File "/home/amarshar/weightfree-tf5/QEfficient/blocking/attention_blocking.py", line 96, in past_key_value_update
    key, value = past_key_value.update(key, value, module.layer_idx, cache_kwargs)
                 ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/amarshar/weightfree-tf5/QEfficient/transformers/cache_utils.py", line 1415, in update
...
Traceback (most recent call last):
  ...
  File "/home/amarshar/weightfree-tf5/.venv/lib/python3.12/site-packages/torch/_dynamo/symbolic_convert.py", line 1076, in wrapper
    return inner_fn(self, inst)
           ^^^^^^^^^^^^^^^^^^^^
  File "/home/amarshar/weightfree-tf5/.venv/lib/python3.12/site-packages/torch/_dynamo/symbolic_convert.py", line 2998, in COMPARE_OP
    self.push(compare_op_handlers[inst.argval](self, self.popn(2), {}))
              ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/amarshar/weightfree-tf5/.venv/lib/python3.12/site-packages/torch/_dynamo/variables/builtin.py", line 1604, in call_function
    return handler(tx, args, kwargs)  # type: ignore[return-value]
           ^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/amarshar/weightfree-tf5/.venv/lib/python3.12/site-packages/torch/_dynamo/variables/builtin.py", line 1560, in _handle_insert_op_in_graph
  ...
  File "/home/amarshar/weightfree-tf5/.venv/lib/python3.12/site-packages/torch/_dynamo/utils.py", line 3940, in get_fake_value
    return _get_fake_value_impl(node, tx, allow_non_graph_fake)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/amarshar/weightfree-tf5/.venv/lib/python3.12/site-packages/torch/_dynamo/utils.py", line 4145, in _get_fake_value_impl
  ...
  File "/home/amarshar/weightfree-tf5/.venv/lib/python3.12/site-packages/torch/_dynamo/utils.py", line 3926, in _wrap_graph_break_with_torch_runtime_err
    gb_fn()
  File "/home/amarshar/weightfree-tf5/.venv/lib/python3.12/site-packages/torch/_dynamo/utils.py", line 4146, in <lambda>
